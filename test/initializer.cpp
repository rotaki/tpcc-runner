...
namespace Initializer {
  ...
  void create_and_insert_history_record(uint16_t h_c_w_id, uint8_t h_c_d_id, uint32_t h_c_id, uint16_t d_w_id, uint8_t h_d_id, uint8_t h_id) {
  ...
  int64_t create_and_insert_order_record(uint16_t o_w_id, uint8_t o_d_id, uint32_t o_c_id, uint32_t o_id) {
  ...
  void create_and_insert_orderline_record(uint16_t ol_w_id, uint8_t ol_d_id, uint32_t ol_o_id, uint16_t ol_supply_w_id, uint32_t ol_i_id, uint8_t ol_number, int64_t o_entry_d) {
  ...
  void load_histories_table(uint16_t w_id, uint8_t d_id, uint32_t c_id) {
    create_and_insert_history_record(w_id, d_id, c_id, w_id, d_id, History::HISTS_PER_CUST); // History::HISTS_PER_CUST = 1
  }
  ...
  void load_orderlines_table(uint16_t ol_w_id, uint8_t ol_d_id, uint32_t ol_o_id, int64_t o_entry_d) {
    ...
    for (uint8_t ol_number = 1; ol_number <= ol_cnt; ol_number++) {
      ...
      create_and_insert_orderline_record(ol_w_id, ol_d_id, ol_o_id, ol_w_id, ol_i_id, ol_number, o_entry_d);
    }
  }
